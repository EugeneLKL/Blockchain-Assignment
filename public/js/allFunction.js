...
const Address = '0xbc791648d884696997064b98E29e049298c582e9';
...
const createDistributionCenter = async () => {
    ...
    const distributionCenterOperatingYears = document.getElementById("dcOperatingYears").value;
    const distributionCenterLocation = document.getElementById("dcLocation").value;
...
const getDistributionCenterInfo = async () => {
    const distributionCenterAddress = document.getElementById("distributionCenterAddress").value;

    if (window.ethereum !== "undefined") {
        console.log(window.contract.methods);
        const result = await window.contract.methods.getDistributionCenterInfo(distributionCenterAddress).call();
        console.log(result);
    }
}
...
const addFarmerToFarm = async () => {
    ...
    if (window.ethereum !== "undefined") {
        const result = await window.contract.methods.addFarmerToFarm(farmAddress, farmerAddress).send({ from: account });
        console.log(result);
    }
}
...
const addTreeToFarm = async () => {
    ...
    if (window.ethereum !== "undefined") {
        console.log(window.contract.methods);
        const result = await window.contract.methods.addTreeToFarm(farmAddress, treeId).send({ from: account });
        console.log(result);
    }
}
...
const createDurian = async () => {
    ...
    if (window.ethereum !== "undefined") {
        console.log(window.contract.methods);
        const result = await window.contract.methods.createDurian(durianType, farmAddress, treeAddress, harvestDate, harvestTime).send({ from: account });
        console.log(result);
    }
}
...
const getDistributorDistributionCenter = async (address) => {
    if (window.ethereum !== "undefined") {
        const result = await window.contract.methods.getDistributorDistributionCenter(address).call();
        console.log(result);
        return result;
    }
}
...
const getDistributionCenterOwner = async (address) => {
    if (window.ethereum !== "undefined") {
        const result = await window.contract.methods.getDistributionCenterOwner(address).call();
        console.log(result);
        return result;
    }
}
...
const addDistributorToDistributionCenter = async () => {
    ...
    if (window.ethereum !== "undefined") {
        console.log(window.contract.methods);
        const result = await window.contract.methods.addDistributorToDistributionCenter(distributionCenterAddress, distributorAddress).send({ from: account });
        console.log(result);
    }
}
...
const updateDurianInfoForDistributor = async () => {
    ...
    const distributionCenterAddress = document.getElementById("distributionCenterAddress").value;
    const dateReceivedFromFarm = document.getElementById("dateReceivedFromFarm").value;

    if (window.ethereum !== "undefined") {
        console.log(window.contract.methods);
        const result = await window.contract.methods.updateDurianInfoForDistributor(durianAddress, distributionCenterAddress, dateReceivedFromFarm).send({ from: account });
        console.log(result);
    }
}
...
const updateDatePassToRetailer = async () => {
    const durianAddress = document.getElementById("durianAddress").value;
    const datePassToRetailer = document.getElementById("datePassToRetailer").value;

    if (window.ethereum !== "undefined") {
        console.log(window.contract.methods);
        const result = await window.contract.methods.updateDatePassToRetailer(durianAddress, datePassToRetailer).send({ from: account });
        console.log(result);
    }
}
...
const updateDurianInfoForRetailer = async () => {
    ...
    const dateReceivedFromDistributionCenter = document.getElementById("dateReceivedFromDistributionCenter").value;

    if (window.ethereum !== "undefined") {
        console.log(window.contract.methods);
        const result = await window.contract.methods.updateDurianInfoForRetailer(durianAddress, retailerAddress, dateReceivedFromDistributionCenter).send({ from: account });
        console.log(result);
    }
}
...
const updateRetailerInfo = async () => {
    ...
    const retailerOperatingYears = document.getElementById("retailerOperatingYears").value;

    if (window.ethereum !== "undefined") {
        console.log(window.contract.methods);
        const result = await window.contract.methods.updateRetailerInfo(retailerAddress, retailerName, retailerLocation, retailerOperatingYears).send({ from: account });
        console.log(result);
    }
}
...
const updateDatePassToConsumer = async () => {
    const durianAddress = document.getElementById("durianAddress").value;
    const datePassToConsumer = document.getElementById("datePassToConsumer").value;

    if (window.ethereum !== "undefined") {
        console.log(window.contract.methods);
        const result = await window.contract.methods.updateDatePassToConsumer(durianAddress, datePassToConsumer).send({ from: account });
        console.log(result);
    }
}
...
const updateDurianInfoForConsumer = async () => {
    ...
    if (window.ethereum !== "undefined") {
        console.log(window.contract.methods);
        const result = await window.contract.methods.updateDurianInfoForConsumer(durianAddress, datePassToConsumer).send({ from: account });
        console.log(result);
    }
}
...
const updateDurianRating = async () => {
    ...
    if (window.ethereum !== "undefined") {
        console.log(window.contract.methods);
        const result = await window.contract.methods.updateDurianRating(durianAddress, taste, fragrance, texture, creaminess, ripeness, gradeRating, comment).send({ from: account });
        console.log(result);
    }
}
